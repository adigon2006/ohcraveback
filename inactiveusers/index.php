...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Users <small>All Inactive Users</small>
			</h3>
			<div class="page-bar">
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-users"></i>Inactive Users
							</div>
							<div class="tools">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											...
											<a style="color:white;" href="../activeusers/addnew.php">Add New <i class="fa fa-plus"></i></a>
											</button>
										</div>
									</div>
