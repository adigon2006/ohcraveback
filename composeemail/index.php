...
<link href="http://fonts.googleapis.com/css?family=Roboto+condensed:400,300,600,700&subset=all" rel="stylesheet" type="text/css"/>
			...
			<!-- BEGIN DASHBOARD STATS -->
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-envelope"></i>New Email
							</div>
							<div class="tools">
				...
				<div class="col-md-12">
					...
					<div class="portlet box yellow">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-envelope"></i>Compose Email Here
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
						...
						<div class="portlet-body form">
								...
								<div id="displaymsg">
									...
									<label class="control-label col-md-2">Message<span class="required">
										* </span>
										...
										<div class="col-md-9">
											<div class="mymessage" name="message" id="summernote_1">
											</div>
										</div>
									</div>
									</div>
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-6 col-md-offset-3">
											<div class="col-md-12"><button type="submit" class="btn green form-control">Send Bulk Email <i class="fa fa-send"></i></button></div>
							...
							<!-- END FORM-->
								...
								<div id="displaymsg2">
									...
									<label class="control-label col-md-2">Message<span class="required">
										* </span>
										...
										<div class="col-md-9">
											<textarea data-provide="markdown-editable" class="well mymessage2">
											</textarea>
										</div>
									</div>
									</div>
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-6 col-md-offset-3">
											<div class="col-md-12"><button type="submit" class="btn green form-control">Send Single Email <i class="fa fa-send"></i></button></div>
