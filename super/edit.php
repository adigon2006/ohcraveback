...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Super Admin <small>Edit Super Admin</small>
			</h3>
			<div class="page-bar">
			...
			<!-- BEGIN DASHBOARD STATS -->
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-users"></i>Edit Super Admin
							</div>
							<div class="tools">
				...
				<div class="col-md-12">
					...
					<div class="portlet box yellow">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Edit Super Admin Details
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
										...
										* </span>
										...
										<div class="col-md-8">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="text" class="form-control" value="<?=$firstname ?>" name="firstname" id="firstname"/>
											</div>
										</div>
									</div>
									</div>
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-8">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="email" class="form-control" value="<?=$email ?>" name="emaill" id="email"/>
											</div>
										</div>
									</div>
									</div>
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-6 col-md-offset-3">
											<div class="col-md-12"><button type="submit" class="btn green form-control">Edit Super Admin <i class="fa fa-users"></i></button></div>
...
<script src="../js/editsuper.js"></script>
