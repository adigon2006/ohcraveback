						...
						<div class="portlet-body form">
							...
							<form action="" id="" class="form-horizontal">
								...
								<div id="displaymsg">
										...
										* </span>
										...
										<div class="col-md-8">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="text" class="form-control" value="<?=$firstname2; ?>" name="firstname" id="firstname"/>
											</div>
										</div>
									</div>
									</div>
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-8">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="text" class="form-control" value="<?=$lastname2; ?>" name="lastname" id="lastname"/>
											</div>
										</div>
									</div>
									</div>
									...
									<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-4">Gender <span class="required">
										* </span>
										</label>
										<div class="col-md-8">
											<div class="input-icon right">
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-8">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="text" class="form-control" value="<?=$phone; ?>" name="mobileno" id="mobileno"/>
											</div>
										</div>
									</div>
									</div>
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-8">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="text" class="form-control" value="<?=$address; ?>" name="address1" id="address1"/>
											</div>
										</div>
									</div>
									</div>
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-8">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="text" class="form-control" value="<?=$country; ?>" name="country" id="country"/>
											</div>
										</div>
									</div>
									</div>
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-8">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="email" class="form-control" value="<?=$email2; ?>" name="emaill" id="email"/>
											</div>
										</div>
									</div>
									</div>
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-8">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="text" class="form-control" value="<?=$username2; ?>" name="username" id="username"/>
											</div>
										</div>
									</div>
									</div>
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-6 col-md-offset-3">
											<div class="col-md-12"><button type="submit" class="btn green form-control">Edit Customer</button></div>
