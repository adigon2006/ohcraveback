		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="addnew.php"><i class="fa fa-plus"></i>Add New User</a>
					</li>
				</ul>
			...
			<!-- BEGIN DASHBOARD STATS -->
				...
				<div class="col-md-12">
					...
					<div class="portlet box yellow">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Enter User Details
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-6 col-md-offset-3">
											<div class="col-md-12"><button type="submit" class="btn green form-control">Add User</button></div>
...
<script src="../js/addnewcus.js"></script>
