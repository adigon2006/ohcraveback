...
$.post('../snippets/editcus.php',{'firstname':firstname,'lastname':lastname,'gender':gender,'mobileno':mobileno,'address1':address1,'email':email,'username':username,'password':password,'state':state,'country':country,'zipcode':zipcode,'id':id},function(data){
