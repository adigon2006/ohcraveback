...
$.post('../snippets/editbankadmin.php',{'firstname':firstname,'lastname':lastname,'bankname':bankname,'username':username,'password':password,'email':email,'id':id},function(data)
